...
def train_fn(train_dataloader, detector, criterion, optimizer, device, scheduler=None):
    ...
    print("Training: ")
    print(
        "Total_loss = {}, BBox_Loss = {}, GIOU_Loss = {}, Labels_Loss = {}".format(
            total_loss.avg, bbox_loss.avg, giou_loss.avg, labels_loss.avg
        )
    )
    return total_loss
...
def eval_fn(val_dataloader, detector, criterion, device):
    ...
    print(
        "Total_loss = {}, BBox_Loss = {}, GIOU_Loss = {}, Labels_Loss = {}".format(
            eval_loss.avg, bbox_loss.avg, giou_loss.avg, labels_loss.avg
        )
    )
